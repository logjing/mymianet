...
for sp in [0,1,2,3]:
    for mm in ['val']:
        ...
        root_path = 'E:\ShangJinlong\dataset\MSCOCO2014'
        ...
        # get data_list
        fss_list_root = 'E:/ShangJinlong/Project/insight1/HDMNet-main/lists/{}/fss_list/{}/'.format(args.data_set, args.mode)
        ...
        for line in f_str:
            ...
            mask = mask.replace("../data", "E:\ShangJinlong\dataset").replace("annotations/" + mm + "2014", mm + "_contain_crowd")
